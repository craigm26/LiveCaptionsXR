  ...
  Future<void> _startAudioCapture() async {
    ...
    try {
      ...
      _captureSub = _audioCapture.frames.listen((frame) async {
        ...
        _logger.d('🧭 Estimated direction: ${angle.toStringAsFixed(1)}°', category: LogCategory.audio);
        
        _logger.d('⚠️ Speech processor not available or not processing', category: LogCategory.audio);
