...
final GoRouter router = GoRouter(
  ...
  redirect: (context, state) {
    ...
    _routerLogger.d('🗺️ Available routes: /home, /settings, /about, /models, /model-status, /model-downloads, /spatial-captions-demo, /video-test', category: LogCategory.system);
    return null;
  },
  ...
  routes: <RouteBase>[
    ...
    ShellRoute(
      ...
      routes: <RouteBase>[
        ...
        GoRoute(
          path: '/model-downloads',
          builder: (BuildContext context, GoRouterState state) {
            _routerLogger.d('🗺️ Building ModelDownloadsPage route', category: LogCategory.system);
            return const ModelDownloadsPage();
          },
        ),
        GoRoute(
          path: '/models',
          builder: (BuildContext context, GoRouterState state) {
            _routerLogger.d('🗺️ Building ModelManagementPage route', category: LogCategory.system);
            return const ModelManagementPage();
          },
        ),
        GoRoute(
