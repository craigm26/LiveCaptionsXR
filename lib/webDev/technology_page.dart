...
class _TechnologyPageState extends State<TechnologyPage> with TickerProviderStateMixin {
    ...
    final aiTechnologies = [
      {
        ...
        'description': 'On-device large language model for real-time speech recognition',
        'icon': Icons.psychology,
        'features': ['On-device inference', 'Multi-language support', 'Low latency', 'Privacy-first'],
      },
      {
        'name': 'TensorFlow Lite',
        'description': 'Mobile-optimized ML framework for edge computing',
        'icon': Icons.apps,
        'features': ['GPU acceleration', 'Model quantization', 'Cross-platform', 'Efficient runtime'],
      },
      {
        'name': 'Core ML',
        'description': 'Apple\'s native ML framework for iOS optimization',
        'icon': Icons.apple,
        'features': ['Hardware acceleration', 'iOS integration', 'Model optimization', 'Neural Engine'],
      },
    ];
    ...
    final audioTechnologies = [
      {
        ...
        'features': ['Real-time processing', 'Spatial audio', 'Low latency', 'Hardware acceleration'],
      },
      {
        'name': 'MediaPipe Audio',
        'description': 'Google\'s audio processing pipeline for ML',
        'icon': Icons.graphic_eq,
        'features': ['Audio classification', 'Voice activity detection', 'Noise reduction', 'Feature extraction'],
      },
      {
        'name': 'FMOD',
        'description': 'Professional audio engine for spatial sound',
        'icon': Icons.surround_sound,
        'features': ['3D audio', 'Real-time effects', 'Cross-platform', 'Low-level control'],
      },
    ];
    ...
    final visionTechnologies = [
      {
        ...
        'icon': Icons.face,
        'features': ['468 facial landmarks', 'Real-time tracking', 'Multi-face support', 'Cross-platform'],
      },
      {
        'name': 'Vision Framework',
        'description': 'Apple\'s computer vision framework',
        'icon': Icons.visibility,
        'features': ['Face detection', 'Object tracking', 'Text recognition', 'Barcode scanning'],
      },
      {
        'name': 'OpenCV',
        'description': 'Open-source computer vision library',
        'icon': Icons.camera_alt,
        'features': ['Image processing', 'Feature detection', 'Video analysis', 'Machine learning'],
      },
    ];
    ...
    final arTechnologies = [
      {
        ...
        'features': ['World tracking', 'Plane detection', 'Light estimation', 'Face tracking'],
      },
      {
        'name': 'RealityKit',
        'description': 'High-performance 3D rendering for AR',
        'icon': Icons.threed_rotation,
        'features': ['Physically based rendering', 'Animation system', 'Audio spatialization', 'Occlusion'],
      },
      {
        'name': 'Flutter AR',
        'description': 'Cross-platform AR integration for Flutter',
        'icon': Icons.flutter_dash,
        'features': ['Cross-platform', 'Widget integration', 'Native performance', 'Hot reload'],
      },
    ];
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Wrap(
                        spacing: 8,
                        children: (tech['features'] as List<String>).map((feature) => 
                          Container(
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                _buildArchitectureLayer('Input Layer', 'Camera • Microphone • Sensors', Icons.input),
                const SizedBox(height: 16),
                Icon(Icons.arrow_downward, color: Colors.grey[600]),
                const SizedBox(height: 16),
                _buildArchitectureLayer('Processing Layer', 'Gemma 3n • MediaPipe • Kalman Filter', Icons.memory),
                const SizedBox(height: 16),
                Icon(Icons.arrow_downward, color: Colors.grey[600]),
                const SizedBox(height: 16),
                _buildArchitectureLayer('Output Layer', 'AR Overlay • Haptic Feedback • Audio', Icons.output),
              ],
            ),
          ),
        ],
  ...
  Widget _buildArchitectureLayer(String title, String components, IconData icon) {
    return Container(
  ...
  Widget _buildPerformanceMetrics(BuildContext context, bool isMobile) {
    final metrics = [
      ...
      {'metric': 'Battery Life', 'value': '8+ hours', 'icon': Icons.battery_full},
